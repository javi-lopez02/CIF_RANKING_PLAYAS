...
interface YearReportsPageProps {
  reports?: ReportCardProps[];
}

const YearReportsPage: React.FC<YearReportsPageProps> = ({
  reports = [
    {
      imageUrl:
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-12">
          ...
          <div className="prose max-w-none text-gray-600 leading-relaxed">
            <p className="text-lg mb-4 text-justify">
              ...
              playas del mundo del presente año. Cada reporte contiene análisis
...
export default YearReportsPage;

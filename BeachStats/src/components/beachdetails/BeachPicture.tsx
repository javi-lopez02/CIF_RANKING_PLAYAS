...
export function BeachPicture({ images }: BeachPictureProps) {
  ...
  const updateThumbnailsVisibility = (activeIndex: number) => {
    ...
    if (
      ...
      if (newStartIndex + maxVisibleThumbnails > images.length) {
        newStartIndex = Math.max(0, images.length - maxVisibleThumbnails);
      }
    ...
    <div className="w-full max-w-full overflow-hidden">
      ...
      <div className="relative w-full">
        ...
        <div className="relative w-full aspect-[4/3] md:aspect-video bg-gray-200 overflow-hidden rounded-md">
          ...
          {/* Controles de navegación superpuestos (opcional para móvil) */}
        ...
        {/* Área de miniaturas - optimizado para responsive */}
        ...
        {/* Controles e indicador de posición - reposicionados para mejor UX */}
